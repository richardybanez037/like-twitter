  ...
  return <div className="flex flex-col sm:flex-row h-screen">
    ...
    <div className="w-full flex justify-center">
      <div className="sm:p-12 py-12">
        ...
        <button className="mt-5 flex items-center justify-center w-full h-11 rounded-full gap-2 px-20 bg-gray-100 text-gray-900 cursor-pointer">
        ...
        <button 
          className="sm:text-md text-sm flex items-center justify-center w-full h-11 rounded-full px-20 bg-blue-500 text-gray-200 font-bold cursor-pointer hover:bg-blue-600 duration-200"
        ...
        <div className="mt-15">
          ...
          <button 
            className="sm:text-md text-sm flex items-center justify-center w-full h-11 rounded-full px-20 bg-black border border-gray-500 text-blue-500 font-bold cursor-pointer hover:bg-blue-500/10 duration-200"
